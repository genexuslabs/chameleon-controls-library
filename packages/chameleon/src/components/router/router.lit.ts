...
export class ChRouter extends KasstorElement {
  ...
  #renderNotFound = () => {
    if (DEV_MODE) {
      console.warn("The route was not found in the model", this.pathname, this.model);
    }
  ...
  #renderPathname = () => {
    ...
    return itemModel ? this.#renderRouterItem(itemModel, pathSegments) : this.#renderNotFound();
  };
