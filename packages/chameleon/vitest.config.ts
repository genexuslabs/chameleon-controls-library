    ...
    projects: [
      ...
      // Tests that runs on the Browser
      {
        ...
        test: {
          ...
          include: ["src/testing/execution/accessible-name-and-label-variants.e2e.ts","src/components/breadcrumb/tests/breadcrumb.e2e.ts","src/components/json-render/tests/json-render.e2e.ts","src/components/accordion/tests/basic.e2e.ts","src/components/accordion/tests/expand-collapse.e2e.ts","src/components/accordion/tests/events.e2e.ts","src/components/accordion/tests/accessibility.e2e.ts","src/components/accordion/tests/parts.e2e.ts","src/components/accordion/tests/lazy-rendering.e2e.ts","src/components/accordion/tests/signal-updates.e2e.ts","src/components/status/tests/basic.e2e.ts","src/components/status/tests/accessibility.e2e.ts","src/components/status/tests/form-associated.e2e.ts","src/components/status/tests/loading-region.e2e.ts","src/components/math-viewer/tests/basic.e2e.ts","src/components/math-viewer/tests/rendering.e2e.ts","src/components/math-viewer/tests/error-handling.e2e.ts","src/components/math-viewer/tests/parts.e2e.ts","src/components/action-menu/tests/basic.e2e.ts","src/components/action-menu/tests/parts.e2e.ts","src/components/action-menu/tests/events.e2e.ts","src/components/action-menu/tests/accessibility.e2e.ts","src/components/action-group/tests/basic.e2e.ts","src/components/action-group/tests/parts.e2e.ts","src/components/action-group/tests/events.e2e.ts","src/components/action-group/tests/responsive-collapse.e2e.ts","src/components/confirmation/tests/confirmation.e2e.ts","src/utilities/host/tests/host.e2e.ts"],
          name: "browser",
          browser: {
            provider: playwright(),
