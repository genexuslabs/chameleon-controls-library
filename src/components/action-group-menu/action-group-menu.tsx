 ...
 */
@Component({
  tag: "ch-action-group-menu",
  styleUrl: "action-group-menu.scss",
  shadow: true
})
export class ChActionGroupMenu implements ChComponent {
  private items: HTMLChActionGroupItemElement[] = [];

  @Element() el: HTMLChActionGroupMenuElement;
  ...
  private escapeOnDeactivatedItem = () => {
    const parent = this.el.parentElement as HTMLChActionGroupItemElement;
    ...
    switch (keyboardEvent.code) {
      ...
      case ARROWLEFT_KEY_CODE:
        ...
        const menuParent = this.el
          .parentElement as HTMLChActionGroupItemElement;
        if (menuParent) {
          menuParent.deactivated = true;
          const menuAncestor =
            menuParent.parentElement as HTMLChActionGroupMenuElement;
          if (menuAncestor) {
