...
| `translations` _(required)_ | --                         | Specifies the literals required for the control.                                                                                                         | `{ confirm: string; cancel: string; confirmDelete: string; cancelDelete: string; confirmModify: string; cancelModify: string; pin: string; unpin: string; delete: string; modify: string; }`                                                        | `undefined` |
