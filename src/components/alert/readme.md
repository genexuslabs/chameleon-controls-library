...
| `presented`                 | `presented`                    | Determine if the element is displayed or not.                                                                                                                                | `boolean` | `false`               |
...
| ------- | ----------------- | ------------------ |
| `close` | Fires close event | `CustomEvent<any>` |
...
graph TD;
  ch-alert --> ch-timer
  style ch-alert fill:#f9f,stroke:#333,stroke-width:4px
```
