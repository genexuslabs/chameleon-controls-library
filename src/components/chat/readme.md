...
| `record`                          | --                    | Specifies the record that the chat will display.                                                                                                       | `ChatMessage[]`                                                                                                                                                                                                                                                                                                                                                   | `[]`                                                                                                        |
| `renderItem`                      | --                    | This property allows us to implement custom rendering of chat items.                                                                                   | `(messageModel: ChatMessage) => any`                                                                                                                                                                                                                                                                                                                              | `defaultChatRender(       this.translations,       this.isMobile,       this.hyperlinkToDownloadFile     )` |
...
| --------- | ---------------------------------------------------------------------------------- | ----------- |
| `message` | `ChatMessageSystem \| ChatMessageUser \| ChatMessageAssistant \| ChatMessageError` |             |
