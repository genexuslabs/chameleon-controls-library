...
| `renderItem`                      | --                    | This property allows us to implement custom rendering of chat items.                                                                                   | `(messageModel: ChatMessage) => any`                                                                                                                                                                                                                                                                                                                              | `messageModel =>       defaultChatRender(         this.translations,         this.isMobile,         this.markdownTheme,         this.hyperlinkToDownloadFile       )(messageModel)` |
