...
| `suggestOptions`     | --                     | This property lets you determine the options that will be applied to the suggest.                                                                                                                                                                                                  | `{ alreadyProcessed?: boolean; autoExpand?: boolean; hideMatchesAndShowNonMatches?: boolean; highlightMatchedItems?: boolean; matchCase?: boolean; regularExpression?: boolean; strict?: boolean; }` | `{}`             |
...
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| `input` | The `input` event is emitted when a change to the element's value is committed by the user.  If `suggest = true`, this event is debounced by the `suggestDebounce` value. | `CustomEvent<string>` |
