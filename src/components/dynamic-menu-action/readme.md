...
| -------------- | --------------- | ------------------------------------------------------------------------------------------------------------------- | --------- | ----------- |
| `actionId`     | `action-id`     | This attribute specifies the id of the ch-dynamic-menu-action for manage from outside, will be an unique attribute. | `string`  | `undefined` |
| `activeClass`  | `active-class`  | A CSS class to set as the `ch-dynamic-menu-action` element class when `inactivated = false`.                        | `string`  | `undefined` |
| `cssClass`     | `css-class`     | A CSS class to set as the `ch-dynamic-menu-action` element class.                                                   | `string`  | `undefined` |
...
| `popupId`      | `popup-id`      | This attribute specifies which popup of the ch-dynamic-menu must be open.                                           | `string`  | `undefined` |
