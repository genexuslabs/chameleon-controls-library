...
| `showAdditionalContentAfter`      | `show-additional-content-after`       | If `true`, a slot is rendered in the edit with `"additional-content-after"` name. This slot is intended to customize the internal content of the edit by adding additional elements after the edit content.                                                                                                           | `boolean`                                                                                                                     | `undefined`      |
| `showAdditionalContentBefore`     | `show-additional-content-before`      | If `true`, a slot is rendered in the edit with `"additional-content-before"` name. This slot is intended to customize the internal content of the edit by adding additional elements before the edit content.                                                                                                         | `boolean`                                                                                                                     | `undefined`      |
