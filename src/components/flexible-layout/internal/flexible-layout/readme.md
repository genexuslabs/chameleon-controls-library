...
- [Methods](#methods)
  ...
  - [`refreshLeaf`](#refreshleafleafid-string--promisevoid)
  - [`removeItemPageInView`](#removeitempageinviewviewid-string-itemid-string-forcererender-boolean--promisevoid)
  - [`removeView`](#removeviewitemid-string--promiseflexiblelayoutviewremoveresult)
