...
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `viewId`     | `string`                                                                                                                                                                                                                                              |             |
| `properties` | `{ type?: "tabbed"; closeButtonHidden?: boolean; dragOutsideDisabled?: boolean; showCaptions?: boolean; sortable?: boolean; tabButtonHidden?: boolean; tabDirection?: FlexibleLayoutLeafTabDirection; tabPosition?: FlexibleLayoutLeafTabPosition; }` |             |
