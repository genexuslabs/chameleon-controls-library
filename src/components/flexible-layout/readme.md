...
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `viewId`     | `string`                                                                                                                                                                                                                                                    |             |
| `properties` | `{ disabled?: boolean; type?: "tabbed"; closeButton?: boolean; dragOutside?: boolean; showCaptions?: boolean; sortable?: boolean; tabButtonHidden?: boolean; tabDirection?: FlexibleLayoutLeafTabDirection; tabPosition?: FlexibleLayoutLeafTabPosition; }` |             |
