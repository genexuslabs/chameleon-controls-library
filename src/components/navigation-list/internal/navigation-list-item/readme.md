...
| `selectedItemIndicator`    | `selected-item-indicator`    | Specifies if the selected item indicator is displayed when the item is selected. Only applies when the `link` property is defined.                                                                                                        | `boolean`                                                                                                                                                                                                 | `false`        |
