...
| `link`                     | --                           | Specifies the hyperlink properties of the item. If this property is defined, the `ch-navigation-list-item` will render an anchor tag with this properties. Otherwise, it will render a button tag.                                     | `{ url: string; target?: "_self" \| "_blank" \| "_parent" \| "_top" \| "_unfencedTop"; }`                                                                                                                 | `undefined`    |
