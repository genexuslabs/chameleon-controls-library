...
| `captions`         | --                   | The labels used in the buttons of the items. Important for accessibility.                                                                                                                                        | `{ collection: string; confirm: string; cancel: string; delete: string; ATT: string; ENTITY: string; LEVEL: string; adding: string; addNewEntity: string; addNewField: string; edit: string; editing: string; deleting: string; deleteMode: string; newEntity: string; newField: string; }` | `undefined` |
