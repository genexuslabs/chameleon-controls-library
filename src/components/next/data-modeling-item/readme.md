...
- [Events](#events)
- [Methods](#methods)
  - [`checkErrors`](#checkerrorserrors-yes--no--unknown-event-customevent--uievent--promisevoid)
  - [`clearInput`](#clearinput--promisevoid)
  - [`delete`](#deleteevent-uievent--promisevoid)
  - [`hideWaitingMode`](#hidewaitingmode--promisevoid)
  - [`setAddingMode`](#setaddingmode--promisevoid)
- [Slots](#slots)
...
| `captions`         | --                   | The labels used in the buttons of the items. Important for accessibility.                                                                                                                                        | `{ collection: string; confirm: string; edit: string; delete: string; cancel: string; ATT: string; ENTITY: string; LEVEL: string; editing: string; adding: string; addNewEntity: string; addNewField: string; deleting: string; deleteMode: string; newEntity: string; newField: string; }` | `undefined` |
