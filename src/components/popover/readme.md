...
| `closeOnClickOutside` | `close-on-click-outside` | This property only applies for `"manual"` mode. In native popovers, when using `"manual"` mode the popover doesn't close when clicking outside the control. This property allows to close the popover when clicking outside in `"manual"` mode.                                                                                                                                                                                                                                            | `boolean`                                                                        | `false`     |
...
| `positionTry`         | `position-try`           | Specifies an alternate position to try when the control overflows the window.                                                                                                                                                                                                                                                                                                                                                                                                              | `"flip-block" \| "flip-inline" \| "none"`                                        | `"none"`    |
