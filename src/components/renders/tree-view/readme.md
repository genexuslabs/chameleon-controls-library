...
| `renderItem`                 | --                  | This property allows us to implement custom rendering of tree items.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `(itemModel: any, treeState: ChTreeViewRender, treeHasFilter: boolean, lastItem: boolean, level: number) => any`                                       | `defaultRenderItem`            |
...
| `selectedItemsChange` | Fired when the selected items change.                                                                    | `CustomEvent<TreeViewItemModelExtended[]>`                                                                           |
