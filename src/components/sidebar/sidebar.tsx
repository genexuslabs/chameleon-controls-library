 ...
 * @status experimental
 *
 * @part expand-button - The button that toggles the expanded/collapsed state. Rendered when `showExpandButton` is `true`.
 * @part expanded - Present on the expand button when the sidebar is expanded.
 * @part collapsed - Present on the expand button when the sidebar is collapsed.
 *
 * @slot - Default slot for the sidebar content.
 */
@Component({
  shadow: true,
