...
@Component({
  ...
  styleUrl: "tabular-grid-virtual-scroller.scss",
  shadow: false
})
export class ChTabularGridVirtualScroller {
  private gridEl: HTMLElement;
  private gridLayoutEl: HTMLElement;
  private resizeObserver: ResizeObserver;

  @Element() el: HTMLChTabularGridVirtualScrollerElement;
  ...
  virtualHeightHandler() {
    ...
    this.gridLayoutEl.style.setProperty(
      "--ch-tabular-grid-virtual-scroller-height",
  ...
  componentWillLoad() {
    ...
    this.gridEl = this.el.closest("ch-tabular-grid");
