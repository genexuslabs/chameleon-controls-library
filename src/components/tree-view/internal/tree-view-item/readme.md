...
- [Events](#events)
- [Methods](#methods)
  - [`focusLastItem`](#focuslastitemctrlkeypressed-boolean--promisevoid)
  - [`focusNextItem`](#focusnextitemctrlkeypressed-boolean--promisevoid)
  - [`focusNextSibling`](#focusnextsiblingctrlkeypressed-boolean--promisevoid)
  - [`focusPreviousItem`](#focuspreviousitemctrlkeypressed-boolean--promisevoid)
  - [`setFocus`](#setfocusctrlkeypressed-boolean--promisevoid)
  - [`updateChecked`](#updatecheckednewchecked-boolean-newindeterminate-boolean--promisevoid)
...
| `getImagePathCallback` _(required)_ | --                         | This property specifies a callback that is executed when the path for an item image needs to be resolved.                                                                                                                                                                                  | `(item: TreeViewItemModel, iconDirection: "start" \| "end") => string \| TreeViewItemImageMultiState`                                                                                                                                                                                                                                                                                                                                                                                                                                  | `undefined`     |
...
| `model`                             | --                         | Specifies the model of the item.                                                                                                                                                                                                                                                           | `{ id: string; caption: string; checkbox?: boolean; checked?: boolean; disabled?: boolean; downloading?: boolean; dragDisabled?: boolean; dropDisabled?: boolean; editable?: boolean; expanded?: boolean; endImgSrc?: string; endImgType?: ImageRender; lastItemId?: string; lazy?: boolean; leaf?: boolean; indeterminate?: boolean; items?: TreeViewModel; metadata?: string; order?: number; parts?: string; render?: boolean; selected?: boolean; startImgSrc?: string; startImgType?: ImageRender; toggleCheckboxes?: boolean; }` | `undefined`     |
