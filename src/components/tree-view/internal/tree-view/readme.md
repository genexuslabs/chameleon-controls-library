...
- [Events](#events)
- [Methods](#methods)
  - [`scrollIntoVisible`](#scrollintovisibletreeitemid-string--promisevoid)
  - [`updateValidDropZone`](#updatevaliddropzonerequesttimestamp-number-newcontainerid-string-draggeditems-gxdatatransferinfo-droptype-treeviewdroptype-validdrop-boolean--promisevoid)
