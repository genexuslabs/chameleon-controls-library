...
| `endImageSrc`            | `end-image-src`            | Specifies the src of the end image.                                                                                                                                                                                                                                                        | `string`                           | `undefined`     |
| `endImageType`           | `end-image-type`           | Specifies how the end image will be rendered.                                                                                                                                                                                                                                              | `"background" \| "img" \| "mask"`  | `"background"`  |
...
| `startImageSrc`          | `start-image-src`          | Specifies the src of the start image.                                                                                                                                                                                                                                                      | `string`                           | `undefined`     |
| `startImageType`         | `start-image-type`         | Specifies how the start image will be rendered.                                                                                                                                                                                                                                            | `"background" \| "img" \| "mask"`  | `"background"`  |
