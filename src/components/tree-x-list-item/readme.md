...
| `selectedItemChange` | Fired when the control is selected.                                    | `CustomEvent<{ ctrlKeyPressed: boolean; expanded: boolean; goToReference: boolean; id: string; itemRef: HTMLChTreeXListItemElement; metadata: string; parentId: string; selected: boolean; }>` |
